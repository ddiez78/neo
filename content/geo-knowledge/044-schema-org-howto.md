---
title: "HowTo - Schema.org Type"
description: "Schema.org Type: HowTo - Instructions that explain how to achieve a result by performing a sequence of steps."
...
| --- | --- | --- |
| Properties from [HowTo](https://schema.org/HowTo "HowTo") |
| ``` estimatedCost ``` | [MonetaryAmount](https://schema.org/MonetaryAmount "MonetaryAmount") or [Text](https://schema.org/Text "Text") | The estimated cost of the supply or supplies consumed when performing instructions. |
| ``` performTime ``` | [Duration](https://schema.org/Duration "Duration") | The length of time it takes to perform instructions or a direction (not including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601). |
| ``` prepTime ``` | [Duration](https://schema.org/Duration "Duration") | The length of time it takes to prepare the items to be used in instructions or a direction, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601). |
| ``` step ``` | [CreativeWork](https://schema.org/CreativeWork "CreativeWork") or [HowToSection](https://schema.org/HowToSection "HowToSection") or [HowToStep](https://schema.org/HowToStep "HowToStep") or [Text](https://schema.org/Text "Text") | A single step item (as HowToStep, text, document, video, etc.) or a HowToSection. Supersedes [steps](https://schema.org/steps "steps"). |
| ``` supply ``` | [HowToSupply](https://schema.org/HowToSupply "HowToSupply") or [Text](https://schema.org/Text "Text") | A sub-property of instrument. A supply consumed when performing instructions or a direction. |
| ``` tool ``` | [HowToTool](https://schema.org/HowToTool "HowToTool") or [Text](https://schema.org/Text "Text") | A sub property of instrument. An object used (but not consumed) when performing instructions or a direction. |
| ``` totalTime ``` | [Duration](https://schema.org/Duration "Duration") | The total time required to perform instructions or a direction (including time to prepare the supplies), in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601). |
| ``` yield ``` | [QuantitativeValue](https://schema.org/QuantitativeValue "QuantitativeValue") or [Text](https://schema.org/Text "Text") | The quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles. |
...
Instances of [HowTo](https://schema.org/HowTo "HowTo") may appear as a value for the following properties

| Property | On Types | Description |
| --- | --- | --- |
| [actionProcess](https://schema.org/actionProcess "actionProcess") | [Action](https://schema.org/Action "Action") | Description of the process by which the action was performed. |
