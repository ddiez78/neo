...
publishedTime: "Wed, 10 Dec 2025 18:38:05 GMT"
---

[Skip to main content](https://developers.google.com/search/docs/appearance/ai-features#main-content)
...
*   [English](https://developers.google.com/search/docs/appearance/ai-features)
*   [Deutsch](https://developers.google.com/search/docs/appearance/ai-features?hl=de)
*   [Español](https://developers.google.com/search/docs/appearance/ai-features?hl=es)
*   [Español – América Latina](https://developers.google.com/search/docs/appearance/ai-features?hl=es-419)
*   [Français](https://developers.google.com/search/docs/appearance/ai-features?hl=fr)
*   [Indonesia](https://developers.google.com/search/docs/appearance/ai-features?hl=id)
*   [Italiano](https://developers.google.com/search/docs/appearance/ai-features?hl=it)
*   [Polski](https://developers.google.com/search/docs/appearance/ai-features?hl=pl)
*   [Português – Brasil](https://developers.google.com/search/docs/appearance/ai-features?hl=pt-br)
*   [Tiếng Việt](https://developers.google.com/search/docs/appearance/ai-features?hl=vi)
*   [Türkçe](https://developers.google.com/search/docs/appearance/ai-features?hl=tr)
*   [Русский](https://developers.google.com/search/docs/appearance/ai-features?hl=ru)
*   [العربيّة](https://developers.google.com/search/docs/appearance/ai-features?hl=ar)
*   [हिंदी](https://developers.google.com/search/docs/appearance/ai-features?hl=hi)
*   [ภาษาไทย](https://developers.google.com/search/docs/appearance/ai-features?hl=th)
*   [中文 – 简体](https://developers.google.com/search/docs/appearance/ai-features?hl=zh-cn)
*   [中文 – 繁體](https://developers.google.com/search/docs/appearance/ai-features?hl=zh-tw)
*   [日本語](https://developers.google.com/search/docs/appearance/ai-features?hl=ja)
*   [한국어](https://developers.google.com/search/docs/appearance/ai-features?hl=ko)

[Sign in](https://developers.google.com/_d/signin?continue=https%3A%2F%2Fdevelopers.google.com%2Fsearch%2Fdocs%2Fappearance%2Fai-features&prompt=select_account)
...
*   [Introduction](https://developers.google.com/search/docs)
*   
[](https://developers.google.com/search/docs/appearance/ai-features)Search Essentials 
...
*   
[](https://developers.google.com/search/docs/appearance/ai-features)SEO fundamentals 
    *   [SEO Starter Guide](https://developers.google.com/search/docs/fundamentals/seo-starter-guide)
    *   [How Google Search works](https://developers.google.com/search/docs/fundamentals/how-search-works)
    *   [Creating helpful, reliable, people-first content](https://developers.google.com/search/docs/fundamentals/creating-helpful-content)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Generative AI fundamentals 
...
*   
[](https://developers.google.com/search/docs/appearance/ai-features)Crawling and indexing 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Sitemaps 
        ...
        *   
[](https://developers.google.com/search/docs/appearance/ai-features)Sitemap extensions 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Crawler management 
        ...
        *   
[](https://developers.google.com/search/docs/appearance/ai-features)Google crawlers 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)robots.txt 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Canonicalization 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)AMP 
        *   [AMP on Google Search guidelines](https://developers.google.com/search/docs/crawling-indexing/amp)
        *   [Understand how AMP works in search results](https://developers.google.com/search/docs/crawling-indexing/amp/about-amp)
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)JavaScript 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Page and content metadata 
        *   [Page metadata](https://developers.google.com/search/docs/crawling-indexing/valid-page-metadata)
        *   
[](https://developers.google.com/search/docs/appearance/ai-features)Meta tags 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Removals 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Site moves and changes 
        *   [Redirects and Google Search](https://developers.google.com/search/docs/crawling-indexing/301-redirects)
        *   
[](https://developers.google.com/search/docs/appearance/ai-features)Site moves 
...
*   
[](https://developers.google.com/search/docs/appearance/ai-features)Ranking and search appearance 
    ...
    *   [Images](https://developers.google.com/search/docs/appearance/google-images)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Local features 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Page experience 
        ...
        *   [Get started with signed exchanges on Google Search](https://developers.google.com/search/docs/appearance/signed-exchange)

    *   [Preferred sources](https://developers.google.com/search/docs/appearance/preferred-sources)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Ranking systems 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Ranking updates 
    ...
    *   [Snippets](https://developers.google.com/search/docs/appearance/snippet)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Structured data 
        ...
        *   
[](https://developers.google.com/search/docs/appearance/ai-features)Feature guides 
            ...
            *   
[](https://developers.google.com/search/docs/appearance/ai-features)Shopping 
    ...
    *   [Title links](https://developers.google.com/search/docs/appearance/title-link)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Translated features 
    ...
    *   [Visual Elements gallery](https://developers.google.com/search/docs/appearance/visual-elements-gallery)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Web Stories 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Early Adopters Program 
...
*   
[](https://developers.google.com/search/docs/appearance/ai-features)Monitoring and debugging 
    *   [Debug drops in Search traffic](https://developers.google.com/search/docs/monitor-debug/debugging-search-traffic-drops)
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Monitor with Search Console 
        *   [Get started with Search Console](https://developers.google.com/search/docs/monitor-debug/search-console-start)
        *   [Improve SEO with a bubble chart](https://developers.google.com/search/docs/monitor-debug/bubble-chart-analysis)
        *   [Using Search Console and Google Analytics data for SEO](https://developers.google.com/search/docs/monitor-debug/google-analytics-search-console)

    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Debug with search operators 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Preventing and monitoring abuse 
...
*   
[](https://developers.google.com/search/docs/appearance/ai-features)Site-specific guides 
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Ecommerce 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)International and multilingual 
    ...
    *   
[](https://developers.google.com/search/docs/appearance/ai-features)Explicit content 
...
*   On this page
*   [How AI features work in Search](https://developers.google.com/search/docs/appearance/ai-features#how-ai-features-work)
*   [How to appear in AI features](https://developers.google.com/search/docs/appearance/ai-features#how-to-appear)
    *   [Technical requirements for appearing in AI features](https://developers.google.com/search/docs/appearance/ai-features#technical-requirements-for-appearing-in-ai-features)
    *   [SEO best practices](https://developers.google.com/search/docs/appearance/ai-features#seo-best-practices)

*   [Measuring the performance of your site](https://developers.google.com/search/docs/appearance/ai-features#performance)
*   [Controlling your content in AI features in Search](https://developers.google.com/search/docs/appearance/ai-features#control)
    *   [Troubleshooting preview controls](https://developers.google.com/search/docs/appearance/ai-features#troubleshooting)
...
[Video 3](https://www.youtube.com/watch?v=AnKaUXbwL20)
...
*   [Manage cookies](https://developers.google.com/search/docs/appearance/ai-features#)
